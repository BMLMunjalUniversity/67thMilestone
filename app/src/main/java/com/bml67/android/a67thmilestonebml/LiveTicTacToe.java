...
public class LiveTicTacToe extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_live_tic_tac_toe);
        ...
        FloatingActionButton favorites_fab = (FloatingActionButton) findViewById(R.id.favorites_fab_live_tic_tac_toe);
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                favouritesdatabase fd = new favouritesdatabase("Live Tic Tac Toe","1st March | 4:00 pm","Library Lawn");
...
//        });
        ...
        ImageView email1 = (ImageView) findViewById(R.id.email1_live_tic_tac_toe);
        ...
        ImageView call1 = (ImageView) findViewById(R.id.call1_live_tic_tac_toe);
