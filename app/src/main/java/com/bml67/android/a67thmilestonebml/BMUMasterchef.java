...
public class BMUMasterchef extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bmumasterchef);
        ...
        FloatingActionButton favorites_fab = (FloatingActionButton) findViewById(R.id.favorites_fab_bmumasterchef);
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                favouritesdatabase fd = new favouritesdatabase("BMU Masterchef","3rd March | 11:00 am","GA UG01 & Delicious Cafeteria");
...
//        });
        ...
        ImageView email1 = (ImageView) findViewById(R.id.email1_bmumasterchef);
        ...
        ImageView call1 = (ImageView) findViewById(R.id.call1_bmumasterchef);
        call1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialPhoneNumber("08198907907");
            }
        });

        ImageView email2 = (ImageView) findViewById(R.id.email2_bmumasterchef);
        ...
        ImageView call2 = (ImageView) findViewById(R.id.call2_bmumasterchef);
