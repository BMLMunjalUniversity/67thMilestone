...
public class LineFollower extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton favorites_fab = (FloatingActionButton) findViewById(R.id.favorites_fab_line_follower);
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                favouritesdatabase fd = new favouritesdatabase("Line Follower","2nd March | 12:00 pm","GA UG04");
...
//        });
        ...
        ImageView email1 = (ImageView) findViewById(R.id.email1_line_follower);
        email1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                String[] addresses = {"pradeep.pasula.14eee@bml.edu.in"};
        ...
        ImageView call1 = (ImageView) findViewById(R.id.call1_line_follower);
        call1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialPhoneNumber("08607565488");
            }
        });

        ImageView email2 = (ImageView) findViewById(R.id.email2_line_follower);
        email2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                String[] addresses = {"Sappa.harsha.15ece@gmail.com"};
        ...
        ImageView call2 = (ImageView) findViewById(R.id.call2_line_follower);
        call2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialPhoneNumber("08096099424");
            }
        });
