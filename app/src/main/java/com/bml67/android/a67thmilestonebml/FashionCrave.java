...
public class FashionCrave extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fashion_crave);
        ...
        FloatingActionButton favorites_fab = (FloatingActionButton) findViewById(R.id.favorites_fab_fashion_crave);
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                favouritesdatabase fd = new favouritesdatabase("Fashion Clave","3rd March | 3:00 pm","NB Arena");
...
//        });
        ...
        ImageView email1 = (ImageView) findViewById(R.id.email1_fashion_crave);
        email1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                String[] addresses = {"nandit.mehra.15csc@bml.edu.in"};
        ...
        ImageView call1 = (ImageView) findViewById(R.id.call1_fashion_crave);
        call1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialPhoneNumber("08295671408");
            }
        });

        ImageView email2 = (ImageView) findViewById(R.id.email2_fashion_crave);
        ...
        ImageView call2 = (ImageView) findViewById(R.id.call2_fashion_crave);
        call2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialPhoneNumber("09648369270");
            }
        });
    }
