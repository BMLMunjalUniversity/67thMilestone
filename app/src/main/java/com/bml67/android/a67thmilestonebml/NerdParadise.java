...
public class NerdParadise extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nerd_paradise);
        ...
        FloatingActionButton favorites_fab = (FloatingActionButton) findViewById(R.id.favorites_fab_nerd_paradise);
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                favouritesdatabase fd = new favouritesdatabase("Nerd Paradise","1st March | 2:00 pm","GB LG01");
...
//        });
        ...
        ImageView email1 = (ImageView) findViewById(R.id.email1_nerd_paradise);
        email1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                String[] addresses = {"jagrit.surisetti.15mec@bml.edu.in"};
        ...
        ImageView call1 = (ImageView) findViewById(R.id.call1_nerd_paradise);
        call1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialPhoneNumber("09753038219");
            }
        });

        ImageView email2 = (ImageView) findViewById(R.id.email2_nerd_paradise);
        email2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                String[] addresses = {"shravanth.paturi.15ece@bml.edu.in"};
        ...
        ImageView call2 = (ImageView) findViewById(R.id.call2_nerd_paradise);
        call2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialPhoneNumber("08332069391");
            }
        });
