...
public class Nayavada extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nayavada);
        ...
        FloatingActionButton favorites_fab = (FloatingActionButton) findViewById(R.id.favorites_fab_nayavada);
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                favouritesdatabase fd = new favouritesdatabase("Nayavada","2nd March | 6:30 pm","GA UG04");
...
//        });
        ...
        ImageView email1 = (ImageView) findViewById(R.id.email1_nayavada);
        email1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                String[] addresses = {"sanket.srivastava.14me@bml.edu.in"};
        ...
        ImageView call1 = (ImageView) findViewById(R.id.call1_nayavada);
        call1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialPhoneNumber("09996771912");
            }
        });

        ImageView email2 = (ImageView) findViewById(R.id.email2_nayavada);
        email2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                String[] addresses = {"romit.bhattacharyya.15csc@bml.edu.in"};
        ...
        ImageView call2 = (ImageView) findViewById(R.id.call2_nayavada);
        call2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialPhoneNumber("08902486467");
            }
        });
