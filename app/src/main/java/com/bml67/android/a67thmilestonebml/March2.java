...
public class March2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_march2);
    }
    ...
    public void openKoham(View view){
        Intent i = new Intent(this, KohamNew.class);
        startActivity(i);
    }
    ...
    public void openMyTalk(View view) {
        Intent i = new Intent(this, MyTalkNew.class);
        startActivity(i);
    }

    public void openParikrama(View view) {
        Intent i = new Intent(this, Parikrama.class);
        startActivity(i);
    }
}