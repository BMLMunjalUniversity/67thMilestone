...
public class MatlabQuest extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_matlab_quest);
        ...
        FloatingActionButton favorites_fab = (FloatingActionButton) findViewById(R.id.favorites_fab_matlab_quest);
        favorites_fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                favouritesdatabase fd = new favouritesdatabase("Matlab Quest","3rd March | 10:30 am","Computer Lab");
...
//        });
        ...
        ImageView email1 = (ImageView) findViewById(R.id.email1_matlab_quest);
        email1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                String[] addresses = {"akshay.kumar.14eee@bml.edu.in"};
        ...
        ImageView call1 = (ImageView) findViewById(R.id.call1_matlab_quest);
        call1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dialPhoneNumber("07404449442");
            }
        });
