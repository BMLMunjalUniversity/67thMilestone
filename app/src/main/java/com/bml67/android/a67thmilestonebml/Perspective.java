...
public class Perspective extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.favorites_fab_perspective);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                fdhandler fdh = new fdhandler(getApplicationContext(),null,null,1);
                favouritesdatabase fd = new favouritesdatabase("Perspective","1st March | 3:00 pm","Experience Center");
        ...
        ImageView email1 = (ImageView) findViewById(R.id.email1_perspective);
        ...
        ImageView call1 = (ImageView) findViewById(R.id.call1_perspective);
        ...
        ImageView email2 = (ImageView) findViewById(R.id.email2_perspective);
        ...
        ImageView call2 = (ImageView) findViewById(R.id.call2_perspective);
